...
<!--    <h3 class="bottomTitle">Lorem Ipsum is text of the typesetting industry</h3>-->

<!--    <router-link class="homeButton" to="/">Back to homepage</router-link>-->
...
<style scoped>
  ...
  .homeButton::before{
    content:url('../assets/Vector_Smart_Object1.png');
    margin-right: 15px;
  }
</style>
